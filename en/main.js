...
function handlePricingSlide(inputs, pricingOutputs, billingPeriodInputs) {
  ...
  const billingPeriodText = isYearlyPayment ? 'Billed annually ' : 'Billed monthly';
  ...
  if (totalNumberOfDevices > valueMaxNumberOfDevices) {
	...
	pricingOutputs.value.requiredDevicesText.innerHTML = "UP TO " + valueMaxNumberOfDevices + " DEVICES";
	...
	pricingOutputs.value.pricingCard.classList.add("is-disabled");
	pricingOutputs.value.requiredDevicesText.innerHTML = "PLEASE CHOOSE DEVICES";
	pricingOutputs.business.pricingCard.classList.add("is-disabled");
	pricingOutputs.business.requiredDevicesText.innerHTML = "PLEASE CHOOSE DEVICES";
  } else {
